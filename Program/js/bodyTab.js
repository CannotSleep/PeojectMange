...
layui.define(["element", "jquery"], function(exports) { //标签模块依赖element和jquery模块
	...
	Tab.prototype.render = function() {
		...
		$.get(url, function(data) { //AJAX获取菜单数据
			//显示左侧菜单
			if($(".navBar").html() == '') {
				var _this = this;
	...
	var bodyTab = new Tab();
	exports("bodyTab", function(option) { //定义模块名
...
/*layui.config({
	base: "js/"
}).use(['element','jquery','bodyTab']),function(){
	var element = layui.element();
	$ = layui.jquery;
	tab = layui.bodyTab({
